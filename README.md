...
* [0.66.1](https://hub.docker.com/r/11notes/netbird/tags?name=0.66.1)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird:0.66.1
docker pull ghcr.io/11notes/netbird:0.66.1
docker pull quay.io/11notes/netbird:0.66.1
```
...
*created 04.03.2026, 06:38:18 (CET)*