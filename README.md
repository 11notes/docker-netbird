...
| ---: | ---: | :---: | :---: | :---: |
| netbirdio/* | 410MB | 0:0 | ❌ | amd64, arm64, armv7 |
...
* [0.66.0](https://hub.docker.com/r/11notes/netbird/tags?name=0.66.0)
...
# REGISTRIES ☁️
```
docker pull 11notes/netbird:0.66.0
docker pull ghcr.io/11notes/netbird:0.66.0
docker pull quay.io/11notes/netbird:0.66.0
```
...
*created 25.02.2026, 06:55:15 (CET)*